<div>
    @livewire('admin.button-back-form', [ route('paragrafoShow') ])
                ...
                <div class="grid grid-cols-2">
                    ...
                    <div class="form-control py-2">
                        ...
                        <div class="input-group">
                            <input wire:model="idArtigo" type="text" placeholder="Artigo..." class="input input-bordered" disabled="disabled" />
        ...
        <div class="modal-box w-11/12 max-w-5xl">
            ...
            <div class="overflow-x-auto">
                <table class="table w-full">
                    ...
                    <tbody>
                        @forelse($optionsArtigo as $key => $options)
                        <tr>
                            <td>
                                <div>
