<div>
    <div class="card m-5 bg-base-100 shadow-xl">
        <div class="card-body">
            <div>
                <a href="{{ route('capituloForm', \App\Enums\OptionCrudEnum::Incluir->value) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    @livewire('admin.buttons-crud', [ $capitulo->id, '/' . \App\Enums\RotinasAplicacaoEnum::Capitulo->value, ['visualizar', 'inativar']])
                                    @else
                                    @livewire('admin.buttons-crud', [ $capitulo->id, '/' . \App\Enums\RotinasAplicacaoEnum::Capitulo->value, ['visualizar']])
                                    @endif
                                </div>
                            </td>
                        </tr>
