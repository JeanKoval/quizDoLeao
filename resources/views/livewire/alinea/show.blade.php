...
<div class="card m-5 bg-base-100 shadow-xl">
        <div class="card-body">
            <div class="flex">
                <a href="/{{ \App\Enums\RotinasAplicacaoEnum::Alinea->value }}/incluir">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    @if ($alinea->status==1)
                                        @livewire('buttons-crud', [ $alinea->id, '/' . \App\Enums\RotinasAplicacaoEnum::Alinea->value, ['visualizar', 'inativar']])
                                    @else    
                                        @livewire('buttons-crud', [ $alinea->id, '/' . \App\Enums\RotinasAplicacaoEnum::Alinea->value, ['visualizar']])
                                    @endif
                                </div>
                            </td>
                        </tr>
